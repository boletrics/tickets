...
const categories = [
  { id: "concert", icon: Music, color: "bg-purple-500/10 text-purple-600 dark:text-purple-400 hover:bg-purple-500/20" },
  { id: "sports", icon: Trophy, color: "bg-blue-500/10 text-blue-600 dark:text-blue-400 hover:bg-blue-500/20" },
  { id: "theater", icon: Theater, color: "bg-rose-500/10 text-rose-600 dark:text-rose-400 hover:bg-rose-500/20" },
  {
    id: "festival",
    icon: PartyPopper,
    color: "bg-amber-500/10 text-amber-600 dark:text-amber-400 hover:bg-amber-500/20",
  },
  { id: "comedy", icon: Laugh, color: "bg-green-500/10 text-green-600 dark:text-green-400 hover:bg-green-500/20" },
  {
    id: "conference",
    icon: Presentation,
    color: "bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 hover:bg-cyan-500/20",
  },
  { id: "exhibition", icon: Frame, color: "bg-pink-500/10 text-pink-600 dark:text-pink-400 hover:bg-pink-500/20" },
]
