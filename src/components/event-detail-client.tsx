...
import { ArrowLeft, Calendar, MapPin, Clock, User, Building2 } from "lucide-react"
            ...
            <div>
              ...
              <div className="grid sm:grid-cols-2 gap-4 mb-6">
                ...
                <div className="flex items-start gap-3 p-4 rounded-lg bg-muted/50">
                  ...
                  <div>
                    <p className="text-sm text-muted-foreground mb-1">{t("event.organizer")}</p>
              ...
              {event.artist && (
                <div className="flex items-center gap-3 p-4 rounded-lg bg-muted/50 mb-6">
                  ...
                  <div>
                    <p className="text-sm text-muted-foreground mb-1">{t("event.artist")}</p>
